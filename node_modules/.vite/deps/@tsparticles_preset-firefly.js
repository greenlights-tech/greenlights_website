...
var TrailMaker = class extends ExternalInteractorBase {
  ...
  interact(delta) {
    ...
    const options2 = container.actualOptions, trailOptions = options2.interactivity.modes.trail;
    if (!trailOptions) {
      return;
    }
  ...
  isEnabled(particle) {
    const container = this.container, options2 = container.actualOptions, mouse = container.interactivity.mouse, events = (particle?.interactivity ?? options2.interactivity).events;
  ...
  loadModeOptions(options2, ...sources) {
    if (!options2.trail) {
      options2.trail = new Trail();
    }
    for (const source of sources) {
      options2.trail.load(source?.trail);
    }
  }
  reset() {
  }
...
// node_modules/@tsparticles/preset-firefly/esm/options.js
var options = {
  fullScreen: {
    enable: true,
    zIndex: -1
...
// node_modules/@tsparticles/preset-firefly/esm/index.js
...
//# sourceMappingURL=@tsparticles_preset-firefly.js.map
